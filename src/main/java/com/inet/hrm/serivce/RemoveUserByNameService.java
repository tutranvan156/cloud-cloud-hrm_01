...
@Named("removeUserByName")
@XPortalPageRequest(uri = "user/remove-by-name", inherit = true, transaction = true, result = WebConstant.ACTION_XSTREAM_JSON_RESULT)
@XPortalDataService(description = "removeUserByName")

public class RemoveUserByNameService extends PluginSubfirmAbstraction {
    @Inject
    UserBO userBO;
